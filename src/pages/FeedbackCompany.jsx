...
const CompanyFeedbackForm = () => {
  ...
  const questions = [
    {
      id: 'question1',
      text: 'How would you rate the student\'s technical skills and competency?'
    },
    {
      id: 'question2',
      text: 'How well did the student adapt to the work environment and culture?'
    },
    {
      id: 'question3',
    ...
    {
      id: 'question4',
      text: 'How reliable and punctual was the student throughout the internship?'
    },
    {
      id: 'question5',
      text: 'How would you rate the student\'s initiative and proactive approach?'
    },
    {
      id: 'question6',
      text: 'How well did the student collaborate with team members?'
    },
    {
      id: 'question7',
      text: 'How would you rate the student\'s learning ability and receptiveness to feedback?'
    },
    {
      id: 'question8',
      text: 'How likely are you to consider this student for future opportunities?'
    }
  ];
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Company feedback submitted:', feedbackData);
    alert('Thank you for your feedback! This will help us better support our students and improve our program.');
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FFFEF7' }}>
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-white rounded-lg shadow-lg border border-black">
          <div className="p-8">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-black mb-2">Company Feedback </h2>
              <p className="text-black opacity-70">Please evaluate the student's performance during their internship with your organization.</p>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="p-6 rounded-lg border border-black" style={{ backgroundColor: '#FFFEF7' }}>
                ...
                <p className="text-sm text-black opacity-70 mb-4">
                  Please share specific examples of the student's performance, areas for improvement, strengths observed, and any recommendations for future development.
                </p>
                <textarea
